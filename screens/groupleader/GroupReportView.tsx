  ...
  const reportData = useMemo(() => {
    ...
    if (selectedActivity === 'all') {
        ...
        participationRecords
            .filter(pr => groupTeacherIds.has(pr.teacherUsersId) && filteredActivities.some(act => act.activitiesId === pr.activityId))
            .forEach(pr => {
        ...
        return participationRecords
            .filter(pr => groupTeacherIds.has(pr.teacherUsersId) && pr.activityId === selectedActivity)
            .map(pr => ({
